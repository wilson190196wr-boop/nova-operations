/**
 * Les questions posées avant un premier rendez-vous, affichées sur `/contact`.
 *
 * Une règle tient tout ce bloc : aucun délai ni aucun chiffre de résultat n'y
 * est promis. Les réponses renvoient à ce que le diagnostic révélera, parce
 * qu'un engagement pris ici serait pris sans connaître le dossier.
 */
export const faq = [
  {
